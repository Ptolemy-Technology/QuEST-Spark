...
[![Ubuntu unit](https://github.com/QuEST-Spark/QuEST/workflows/Ubuntu%20unit/badge.svg)](https://github.com/QuEST-Kit/QuEST/actions)
...
The **Quantum Exact Simulation Toolkit on Large-scale Memory Model** is a large dataset universal quantum circuits, state-vectors and density matrices. The foundation "QuEST" is written in C. The extension of QuEST is a framework "Spark". "QuEST" simulator has many advantages such as multicore, GPU-accelerated and networked machines to quickly simulate circuits on many qubits. The "QuEST-Spark" simulator add the feature of the resilient distributed dataset (RDD), a read-only multiset of data items distributed over a cluster of machines, that is maintained in a fault-tolerant way.

QuEST-Spark has a simple interface, independent of its run environment (on CPUs, GPUs or over networks),
```C
hadamard(qubits, 0);
...
* [PyQuEST-cffi](https://github.com/HQSquantumsimulations/PyQuEST-cffi): a python interface to QuEST based on cffi developed by HQS Quantum Simulations. Please note, PyQuEST-cffi is currently
